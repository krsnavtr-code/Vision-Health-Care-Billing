  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
      ...
      <div className="lg:col-span-3 space-y-6">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm space-y-4">
          ...
          {searchCategory !== "Service" ? (
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-11 pr-4 py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-semibold bg-slate-50 focus:bg-white transition"
              />
              {searchQuery && (
                <button
                  onClick={() => {
            ...
            <form onSubmit={handleAddCustomService} className="space-y-3">
              <input
                ...
                className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-semibold bg-slate-50 focus:bg-white transition"
              />
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-semibold bg-slate-50 focus:bg-white transition"
                />
                <select
                  value={customServiceGst}
                  onChange={(e) => setCustomServiceGst(e.target.value)}
                  className="px-4 py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-bold bg-white"
                >
              ...
              <button
                type="submit"
                className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl text-sm flex items-center justify-center gap-2 transition"
              >
          ...
          {searchResults.length > 0 && (
            <div className="border border-slate-200 rounded-xl shadow-lg divide-y divide-slate-100 overflow-hidden bg-white max-h-72 overflow-y-auto">
              {searchResults.map((item) => (
                <div
                  key={item._id}
                  className="p-4 flex justify-between items-center hover:bg-blue-50 cursor-pointer transition group"
                  onClick={() => handleAddToCart(item, searchCategory)}
                >
                  <div className="flex-1">
                    <h4 className="text-sm font-bold text-slate-800 group-hover:text-blue-700 transition">
                    ...
                    <p className="text-xs text-slate-500 font-medium mt-1">
                      {searchCategory === "Medicine" ? (
                        <>
                          <span className="inline-block px-2 py-0.5 bg-slate-100 rounded text-xxs font-bold text-slate-600 mr-2">
                            {item.unit}
                          </span>
                  ...
                  <div className="flex items-center gap-3 ml-4">
                    ...
                    <button className="p-2 bg-blue-600 text-white hover:bg-blue-700 rounded-lg transition shadow-md group-hover:shadow-lg">
            ...
            <div className="divide-y divide-slate-100 overflow-x-auto">
              <table className="min-w-full divide-y divide-slate-100">
                <thead className="bg-slate-50">
                  <tr>
                    <th className="px-4 py-2 text-left text-xxs font-bold text-slate-400 uppercase">
                      Description
                    </th>
                    <th className="px-4 py-2 text-center text-xxs font-bold text-slate-400 uppercase">
                      Rate
                    </th>
                    <th className="px-4 py-2 text-center text-xxs font-bold text-slate-400 uppercase">
                      Period (Rental)
                    ...
                    <th className="px-4 py-2 text-right text-xxs font-bold text-slate-400 uppercase">
                      Total (Excl. Tax)
                    </th>
                    <th className="px-4 py-2 text-right text-xxs font-bold text-slate-400 uppercase">
                      Action
                  ...
                  {cart.map((item) => (
                    <tr key={item.id} className="hover:bg-slate-50/50">
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-center">
                        ...
                        />
                        {item.itemType === "Medicine" && (
                          <div className="text-xxs text-rose-500 font-bold mt-0.5">
      ...
      <div className="space-y-6">
          ...
          <div>
            ...
            {patients.length === 0 ? (
              ...
              <select
                ...
                className="block w-full border-2 border-slate-200 rounded-xl px-4 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white shadow-sm"
              >
                {patients.map((p) => (
        ...
        <div className="bg-gradient-to-br from-emerald-50 to-teal-50 p-5 rounded-2xl border border-emerald-100 shadow-sm space-y-4">
          <div className="flex items-center gap-2">
          ...
          <div className="bg-white rounded-xl p-4 space-y-3 shadow-sm">
            ...
            <div className="flex justify-between text-lg font-black text-slate-800 pt-3 border-t-2 border-slate-100">
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-4 py-3 border-2 border-slate-200 rounded-xl text-sm font-bold focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 bg-white shadow-sm"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <select
                  ...
                  className="block w-full border-2 border-slate-200 rounded-xl px-4 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 bg-white shadow-sm"
                >
              ...
              <div>
                ...
                <div className="block w-full px-4 py-3 rounded-xl bg-rose-100 text-rose-700 font-extrabold text-sm text-right border-2 border-rose-200 shadow-sm">
            ...
            <div>
              ...
              <textarea
                ...
                rows="2"
                className="block w-full border-2 border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 bg-white shadow-sm resize-none"
              />
            </div>
