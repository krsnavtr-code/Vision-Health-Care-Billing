...
export default function Inventory() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-xs text-slate-500 font-medium">
            Manage medicines, consumables, and stocks
          </p>
        </div>
        <button
      ...
      {/* Controls & Search */}
      <div className="bg-white p-3 rounded-xl border border-slate-100 shadow-sm flex flex-col md:flex-row gap-3 justify-between items-center">
              ...
              <tbody className="divide-y divide-slate-100">
                {inventory.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2 whitespace-nowrap text-xs text-center text-slate-500">
                      {item.unit}
                    </td>
                    <td className="px-3 py-2 whitespace-nowrap text-xs text-right font-semibold text-slate-700">
